...
HD_PWD='D:/Xilinx/Projects/The_Little_Rover_that_could/The_Little_Rover_that_could.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Seven_Seg_Mult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Seven_Seg_Mult.tcl -notrace
